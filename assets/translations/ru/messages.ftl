...
msg-menu-editor-button-emoji =
    <b>✨ Изменить Premium Emoji кнопки</b>

    Отправьте ID кастомного эмодзи (числовой идентификатор).
    
    Чтобы узнать ID, отправьте Premium эмодзи в чат с ботом <a href="https://t.me/RawDataBot">@RawDataBot</a> и найдите <code>custom_emoji_id</code> в ответе.
