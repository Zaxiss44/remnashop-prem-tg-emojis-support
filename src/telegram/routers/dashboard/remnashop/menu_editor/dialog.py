...
button = Window(
    ...
    Row(
        SwitchTo(
            text=I18nFormat("btn-menu-editor.emoji"),
            id="emoji",
            state=RemnashopMenuEditor.EMOJI,
        ),
    ),
    Row(
        Button(
...
button_emoji = Window(
    Banner(BannerName.DASHBOARD),
    I18nFormat("msg-menu-editor-button-emoji"),
    Row(
        Button(
            text=I18nFormat("btn-menu-editor.emoji-clear"),
            id="emoji_clear",
            on_click=on_emoji_clear,
        ),
    ),
    Row(
        SwitchTo(
    ...
    MessageInput(func=on_emoji_input),
    IgnoreUpdate(),
    state=RemnashopMenuEditor.EMOJI,
)
